              ...
              Row(
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(color: market.closed ? Colors.grey : Color(0xffd62828), borderRadius: BorderRadius.circular(24)),
                    child: market.closed
                        ? Text(
                            S.of(context).closed,
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: 12, vertical: 3),
                    decoration: BoxDecoration(color: Helper.canDelivery(market) ? Color(0xffd62828) : Colors.orange, borderRadius: BorderRadius.circular(24)),
