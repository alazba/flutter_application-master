              ...
              Row(
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(color: market.closed ? Colors.grey : Color(0xff3d619b), borderRadius: BorderRadius.circular(8)),
                    child: market.closed
                        ? Text(
                            S.of(context).closed,
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: 12, vertical: 3),
                    decoration: BoxDecoration(color: Helper.canDelivery(market) ? Color(0xff3d619b) : Colors.orange, borderRadius: BorderRadius.circular(8)),
