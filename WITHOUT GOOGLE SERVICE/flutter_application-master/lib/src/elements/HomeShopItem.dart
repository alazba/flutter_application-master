              ...
              Flexible(
                child: Column(
                  ...
                  children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: Chip(
                            ...
                            label: Row(
                              ...
                              children: <Widget>[
                                Text(market.rate, style: Theme.of(context).textTheme.bodyText1.merge(TextStyle(color: Theme.of(context).primaryColor))),
                                Icon(
                                  Icons.star_border,
                    ...
                    Text(
                      market.description.substring(0, min(30, market.description.length)),
