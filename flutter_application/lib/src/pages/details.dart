                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(color: _con.market.closed ? Colors.grey : Color(0xff91240C), borderRadius: BorderRadius.circular(24)),
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: Helper.canDelivery(_con.market) ? Color(0xff91240C) : Colors.orange, borderRadius: BorderRadius.circular(24)),
                                  ...
                                  Container(
                                    padding: EdgeInsets.symmetric(horizontal: 12, vertical: 3),
                                    decoration: BoxDecoration(
                                        color: Helper.canDelivery(_con.market) ? Color(0xff91240C) : Colors.grey, borderRadius: BorderRadius.circular(24)),
                                    child: Text(
